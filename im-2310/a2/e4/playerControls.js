...
videoElement.addEventListener("mousecenter", logEvent);
/* LOADING */
...
/* Rewind/Fastforward*/
// The reason I choose these rewind and fastforward function is because sometimes people might lose the important scene, so they'd like to rewind the video to check it, a rewind button can give users this option to easily do it.
// Also, users can easily fastforward the video content to skip the boring part and jump to a specific area they are interested.
